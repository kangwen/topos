...
public class ApiSecurityBeansConfig {
    ...
    public JwtTokenProvider jwtTokenProvider(
            @Value("${topos.security.crm.jwt.secret}") String secret,
            @Value("${topos.security.crm.jwt.expiration-minutes:10080}") long expirationMinutes) {
