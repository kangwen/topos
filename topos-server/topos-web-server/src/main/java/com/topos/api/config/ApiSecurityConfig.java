...
import com.topos.api.security.JwtAuthenticationFilter;
...
public class ApiSecurityConfig {
    ...
    public SecurityFilterChain apiChain(
        ...
        http
                ...
                .addFilterBefore(parentAnonymousPathFilter, UsernamePasswordAuthenticationFilter.class)
