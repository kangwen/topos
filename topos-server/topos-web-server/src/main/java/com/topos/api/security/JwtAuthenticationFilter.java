package com.topos.api.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(@Qualifier("jwtTokenProvider") JwtTokenProvider jwtTokenProvider) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return "/api/vi/auth/login".equals(ApiRequestPaths.pathWithinApplication(request));
    }
